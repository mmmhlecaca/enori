...
func GetChromiumBrowsers() map[string]string {
	return map[string]string{
		...
		"Arc Browser":          "AppData\\Local\\Packages\\TheBrowserCompany.Arc_ttt1ap7aakyb4\\LocalCache\\Local\\Arc\\User Data",
		...
		"AVG Secure Browser":   "AppData\\Local\\AVG Secure Browser\\User Data",
		"Avast Secure Browser": "AppData\\Local\\Avast Secure Browser\\User Data",
...
func GetGeckoBrowsers() map[string]string {
	return map[string]string{
		...
		"Zen Browser": "AppData\\Roaming\\zen\\Profiles",
	}
}
